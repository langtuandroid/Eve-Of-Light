...
namespace NeoFPS
{
    public class BodyLeanBase : MonoBehaviour, IAdditiveTransform, INeoSerializableComponent
    {
        ...
        protected virtual void SetLeanZero()
        {
        ...
        class BodyLeanCounterRotation : MonoBehaviour, IAdditiveTransform
        {
            ...
            public void AttachToBodyLean(BodyLeanBase body)
            {
                m_BodyLean = body;
            }
        }
