...
#pragma warning restore 0649
        ...
        protected void OnValidate()
        {
            ...
            if (!Application.isPlaying && m_EffectTransform != null && (m_EffectTransform == transform || !m_EffectTransform.IsChildOf(transform)))
            {
        ...
        {
            if (c != null && m_WeaponTransform == null && m_EffectTransform != null)
            {
