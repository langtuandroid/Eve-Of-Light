...
namespace NeoFPS
{
	...
	public class CharacterInteractionHandler : MonoBehaviour
	{
		...
		IInteractiveObject GetValidInteractable()
		{
			...
			if (PhysicsExtensions.RaycastNonAllocSingle(ray, out m_Hit, m_MaxDistance, m_Layers, m_LocalTransform, QueryTriggerInteraction.Collide) &&
				m_Hit.collider.isTrigger && m_Hit.collider.gameObject.layer == PhysicsFilter.LayerIndex.InteractiveObjects)
			{
