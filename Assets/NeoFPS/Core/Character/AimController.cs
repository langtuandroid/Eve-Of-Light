...
namespace NeoFPS
{
	public abstract class AimController : MonoBehaviour, IAimController, INeoSerializableComponent
    {
        ...
        [SerializeField, NeoObjectInHierarchyField(false, required = true), Tooltip("The transform to pitch when aiming. This should be a child of the yaw transform.")]
		...
		{
            if (!isValid || Time.deltaTime < Mathf.Epsilon)
                return;
        ...
        public virtual void WriteProperties(INeoSerializer writer, NeoSerializedGameObject nsgo, SaveMode saveMode)
        {
            ...
            if (m_YawConstrained)
            {
                writer.WriteValue(k_YawConstraintKey, m_YawConstraint);
        ...
        public virtual void ReadProperties(INeoDeserializer reader, NeoSerializedGameObject nsgo)
        {
            ...
            if (reader.TryReadValue(k_YawConstraintKey, out m_YawConstraint, m_YawConstraint))
            {
                m_YawConstrained = true;
