...
Shader "Piloto Studio/Toony Prop"
{
	Properties
	{
		...
		[ASEBegin]_MainTex("Base Color", 2D) = "white" {}
		...
		[ASEEnd]_BandingBias("Banding Bias", Float) = 2
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float dotResult98 = dot( worldNormal85 , -_DirectionalLightDatas[0].forward );
				...
				float4 texCoord159 = packedInput.ase_texcoord1;
				texCoord159.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_158_0 = ( texCoord159.z + 1.0 );
				
				float lerpResult109 = lerp( 1.0 , 100.0 , _RimShadow);
				float dotResult103 = dot( V , worldNormal85 );
				float smoothstepResult114 = smoothstep( _RimFalloff.x , _RimFalloff.y , ( 1.0 - saturate( ( dotResult103 + _RimOffset ) ) ));
				
				surfaceDescription.Color = ( ( _Dimming * ( ( tex2DNode111 * SampleGradient( gradient117, ( ( (dotResult98*0.26 + 0.5) * max( max( mainLight86 , 0.0 ) , 0.0 ) ) + max( max( break101.x , break101.y ) , break101.z ) ) ) ) + float4( temp_output_89_0 , 0.0 ) ) ) * packedInput.ase_color * temp_output_158_0 ).rgb;
				surfaceDescription.Emission = ( packedInput.ase_color * ( lerpResult109 * smoothstepResult114 * _RimColor * tex2DNode111 ) * temp_output_158_0 ).rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float3 temp_output_89_0 = _Vector1;
				float3 break101 = temp_output_89_0;
				float4 texCoord159 = packedInput.ase_texcoord;
				texCoord159.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_158_0 = ( texCoord159.z + 1.0 );
...
Node;AmplifyShaderEditor.ColorNode;116;-1515.481,1367.7;Inherit;False;Property;_RimColor;Rim Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0.5549643,1,0;1.498039,1.498039,1.498039,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;111;-1796.405,-412.6855;Inherit;True;Property;_MainTex;Base Color;0;0;Create;False;0;0;0;False;0;False;-1;None;70c9529d91fe35349bd48d06513fb028;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;434.1303,-386.5932;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;13;Piloto Studio/Toony Prop;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;7;True;12;all;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestTransparent;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;0;0;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Motion Vectors;0;638000877583800886;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;638120997321815590;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;7;True;True;True;True;True;False;False;False;;False;0
...
WireConnection;1;2;154;4
ASEEND*/
//CHKSM=77BD608E682F56653CAC0E5F2D1C6007E73EE93E